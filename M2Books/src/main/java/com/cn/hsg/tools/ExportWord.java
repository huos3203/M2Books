...
//import com.topwork.goods.eg8_goods;
...
//        dbd.update(eg8_goods.class,Chain.make("进度", zt),Cnd.where("id","=",id));//更新图书信息表"进度"字段的更新的操作状态
//        dbd.update(eg8_goods.class,Chain.make("YY出版项", chubanxiang),Cnd.where("id","=",id));
//        dbd.update(eg8_goods.class,Chain.make("内容提要", neirongtiyao),Cnd.where("id","=",id));//更新图书信息表"内容提要"字段的更新的操作状态
      	fwtxt.write("[end]"+"\r\n");
    	fwtxt.close();
    }
