...
public class mianjianxiaodiao {
	...
	private static Log log = Logs.getLog(mianjianxiaodiao.class);
...
//					"ioc/btBook.js",
			...
			ioc.get(mianjianxiaodiao.class);
...
//		log.info("notifDao:"+btBooksDao+"notif:"+btBooks);
		...
		for (int i = 41; i <= maxPagenum; i++) {
			z = i + 1;
//			http://www.tingshuge.com/down/?3420-8.html#down
			String url1="http://www.tingshuge.com/down/?3420-"+z+".html#down"; //搜狐图书首地址
